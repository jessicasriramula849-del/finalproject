...
For this project I have built a simple streamlit application which detects leaf disease, here in this repository, I have uploaded all the files including the sample outputs file which contains the predicted queue + hugging face-generated reply as well as the trained model file(best_mobilenetv2_model.pth). To find out more about this project, please see attached my project report.
